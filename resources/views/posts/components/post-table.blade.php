<div class="overflow-x-auto">
    <div class="flex w-full p-3 space-x-2">
        ...
        <div class="w-3/6">
            ...
            focus:outline-none focus:shadow-outline focus-ring-0 foucus:bg-indigo-50" placeholder="Search Posts...">
        </div>
        <!-- Order By -->
        <div class="w-1/6">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6">
                ...
                <div>
                    ...
                    <strong>Content : </strong><span id="view_content"></span><br>
                    <strong>Add By : </strong><span id="view_addby"></span><br>  
                    <strong>Add Date : </strong><span id="view_adddate"></span><br>
                    <strong>Edit By : </strong><span id="view_editby"></span><br> 
                    <strong>Edit Date : </strong><span id="view_editdate"></span><br> 
                </div>                                
            </div>
        </div>
    </div>
    ...
    <div class="relative w-full h-full max-w-md md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 text-center">
                <form method="POST" action="{{ route('posts.destroy', 'data_id') }}">
                    @csrf
                    @method('DELETE')
...
<script>
    ...
    $(document).ready(function(){
        $('.viewBtn').on('click', function(){
            ...
            document.getElementById('view_content').innerHTML = data[2];
            document.getElementById('view_addby').innerHTML = data[3];
            document.getElementById('view_adddate').innerHTML = data[4];
            document.getElementById('view_editby').innerHTML = data[5];
            document.getElementById('view_editdate').innerHTML = data[6];
