<nav class="bg-gray-50 sticky top-0 border-b">
      ...
      <div class="flex items-center">
        <div class="flex-shrink-0">
          <a href="{{ route('dashboard') }}">
              <h1 class="text-emerald-600 font-bold">System</h1>
          </a>
        </div>
  ...
  <div class="md:hidden" id="mobile-menu">
    <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">        
      ...
      <a href="" class="{{ (request()->segment(1) == 'users') ? 'bg-emerald-700 border-emerald-700': '' }} px-3 py-1 flex space-x-2 mt-10 rounded-md border border-gray-50 cursor-pointer hover:bg-emerald-600 hover:border-emerald-700">Users</a>      
    </div>
